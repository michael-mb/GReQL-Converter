  ...
  <div class="card mb-1">
    <div class="card-header">
      <h5 class="accordion-faq m-0 position-relative">
        <a class="custom-accordion-title text-reset d-block" @click="toogle">
          <span class="type"> AG </span> <span class="type_name">{{rule.rule_name}} : {{rule.rule_specific.class_aggregate}}
    ...
    <div class="collapse" :class="isOpen === true ? 'show' : ''">
      <div class="card-body">
        ...
        <div class="form-group row">
          <label class="col-form-label col-md-3">Aggregate</label>
          <div class="col-md-9">
            <input type="text" class="form-control" v-model="rule.rule_specific.class_aggregate">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-9">
            <input type="text" class="form-control" v-model="rule.rule_specific.element_multiplicity">
          </div>
        </div>
