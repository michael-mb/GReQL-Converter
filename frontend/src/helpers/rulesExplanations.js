export default {
    defined_class_rule: "Diese Regel extrahiert die Methoden, Attribute und Besonderheiten aller Klassen und" +
        " Schnittstellen aus Ihrem UML-Diagramm und gibt Ihnen die Möglichkeit, diese zu ändern. Anschließend werden" +
